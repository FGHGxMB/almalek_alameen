...
class PermissionsModel {
  ...
  // الصلاحيات الخاصة بالحسابات المراقبة (تم حذف صلاحيات الإضافة بناء على طلبك)
  final bool customerEditMonitored; final bool customerDeleteMonitored;
  final bool invoiceEditMonitored; final bool invoiceDeleteMonitored;
  final bool returnEditMonitored; final bool returnDeleteMonitored;
  final bool receiptEditMonitored; final bool receiptDeleteMonitored;

  PermissionsModel({
    required this.adminAccess, required this.exportData, required this.companyAccountsView, required this.companyAccountsEdit, required this.updateCurrency,
    ...
    required this.customerEditMonitored, required this.customerDeleteMonitored,
    required this.invoiceEditMonitored, required this.invoiceDeleteMonitored,
    required this.returnEditMonitored, required this.returnDeleteMonitored,
    required this.receiptEditMonitored, required this.receiptDeleteMonitored,
  });
  ...
  factory PermissionsModel.fromMap(Map<String, dynamic> map) {
    return PermissionsModel(
      ...
      companyAccountsView: map['company_accounts_view'] ?? false, companyAccountsEdit: map['company_accounts_edit'] ?? false, updateCurrency: map['update_currency'] ?? false,
      ...
      customerEditMonitored: map['customer_edit_monitored'] ?? false, customerDeleteMonitored: map['customer_delete_monitored'] ?? false,
      invoiceEditMonitored: map['invoice_edit_monitored'] ?? false, invoiceDeleteMonitored: map['invoice_delete_monitored'] ?? false,
      returnEditMonitored: map['return_edit_monitored'] ?? false, returnDeleteMonitored: map['return_delete_monitored'] ?? false,
      receiptEditMonitored: map['receipt_edit_monitored'] ?? false, receiptDeleteMonitored: map['receipt_delete_monitored'] ?? false,
    );
  }

  Map<String, dynamic> toMap() => {
    'admin_access': adminAccess, 'export_data': exportData, 'company_accounts_view': companyAccountsView, 'company_accounts_edit': companyAccountsEdit, 'update_currency': updateCurrency,
    ...
    'customer_edit_monitored': customerEditMonitored, 'customer_delete_monitored': customerDeleteMonitored,
    'invoice_edit_monitored': invoiceEditMonitored, 'invoice_delete_monitored': invoiceDeleteMonitored,
    'return_edit_monitored': returnEditMonitored, 'return_delete_monitored': returnDeleteMonitored,
    'receipt_edit_monitored': receiptEditMonitored, 'receipt_delete_monitored': receiptDeleteMonitored,
  };
}
...
class UserModel {
  ...
  final String cashBoxCode; // <--- الحقل الجديد (رمز الصندوق)
  final String customerSuffix; final String accountColor;
  ...
  UserModel({
    ...
    required this.cashBoxCode, required this.customerSuffix, required this.accountColor,
    required this.canMonitor, required this.isActive, required this.delegateInvoiceCounter,
    required this.delegateReturnCounter, required this.delegateReceiptCounter,
    required this.customerCounter, required this.permissions,required this.password,
  });
  ...
  factory UserModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return UserModel(
      ...
      cashBoxCode: data[FirestoreKeys.cashBoxCode] ?? '', // <--- قراءة الصندوق
      ...
      password: data[FirestoreKeys.password] ?? '',
    );
  }
  ...
  Map<String, dynamic> toFirestore() => {
    ...
    FirestoreKeys.costCenterCode: costCenterCode, FirestoreKeys.cashBoxCode: cashBoxCode, // <--- حفظ الصندوق
    FirestoreKeys.customerSuffix: customerSuffix, FirestoreKeys.accountColor: accountColor,
    FirestoreKeys.canMonitor: canMonitor, FirestoreKeys.isActive: isActive,
    ...
    FirestoreKeys.password: password,
  };
}